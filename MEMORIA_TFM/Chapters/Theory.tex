...
\section{\textbf{Visual cortex}}
	...
	As it is explained in the first chapter of the book \textit{Neuroanatomy, Visual Cortex} \cite{HuffMahabadiTadi2023} the visual cortex is divided into five different areas (V1 to V5). As shown in Figure \ref{fig: Areas_of_the_visual_cortex}, those areas are classified according to their functional and structural characteristics. As information moves through the different areas, it becomes increasingly more specific. Neurons in the visual cortex are typically activated by stimuli within a specific receptive field. Each area contains neurons that are sensitive to different types of stimuli.
